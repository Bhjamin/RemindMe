        ...
        <div className="p-8 bg-base-300/20 shadow-xl z-30 backdrop-blur rounded-xl w-[90%] md:w-[65%] flex flex-row justify-center flex-wrap gap-12 overflow-x-hidden">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col items-center">
                    <h2 className={`text-sm sm:text-lg md:text-3xl transition-all text-secondary ${task1complete && 'line-through'}`}>Workout</h2>
                    {
                        workoutDay ?
                            <>
                    ...
                    task2 ?
                        ...
                        >
                            ...
                            <div className="flex gap-2 items-center">
                                <h2 className={`text-sm sm:text-lg md:text-3xl transition-all ${task2complete && 'line-through'}`}>{task2}</h2>
...

                {
                    task3 ?
                        ...
                        >
                            ...
                            <div className="flex gap-2 items-center">
                                <h2 className={`text-sm sm:text-lg md:text-3xl transition-all ${task3complete && 'line-through'}`}>{task3}</h2>
...

                {
                    task4 ?
                        ...
                        >
                            ...
                            <div className="flex gap-2 items-center">
                                <h2 className={`text-sm sm:text-lg md:text-3xl transition-all ${task4complete && 'line-through'}`}>{task4}</h2>
...

                {
                    task5 ?
                        ...
                        >
                            ...
                            <div className="flex gap-2 items-center">
                                <h2 className={` text-sm sm:text-lg md:text-3xl transition-all ${task5complete && 'line-through'}`}>{task5}</h2>
